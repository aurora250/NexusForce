...
TEST_F(AES256Test, DecryptGcmKnownVectorTest1) {
    const byte_t key_bytes[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a,
                                ...
                                0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f};
    const byte_t iv_bytes[] = {0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b};
    const byte_t ciphertext[] = {0xad, 0x13, 0x05, 0x78, 0xdf};
    const byte_t aad[] = {0x41, 0x55, 0x54, 0x48};
    const byte_t tag[] = {0x14, 0xb8, 0x8f, 0x67, 0x7c, 0xc0, 0x53, 0xae,
                          0x8c, 0xaa, 0xd8, 0x4a, 0xaa, 0xcd, 0x0d, 0x76};
...
TEST_F(AES256Test, DecryptGcmTagLength12) {
    ...
    const byte_t iv_bytes[] = {0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b};
    const byte_t ciphertext[] = {0xad, 0x13, 0x05, 0x78, 0xdf};
    const byte_t tag[] = {0x14, 0xb8, 0x8f, 0x67, 0x7c, 0xc0, 0x53, 0xae, 0x8c, 0xaa, 0xd8, 0x4a};
    const byte_t expected_plaintext[] = {0x48, 0x65, 0x6c, 0x6c, 0x6f};
...
TEST_F(AES256Test, EncryptGcmNon12ByteIv) {
    ...
    const byte_t plaintext[] = {0x48, 0x65, 0x6c, 0x6c, 0x6f};
    const byte_t expected_ciphertext[] = {0x28, 0x5c, 0x02, 0xb9, 0x3d};
    const byte_t expected_tag[] = {0x75, 0x83, 0xb9, 0x3c, 0x6e, 0x5d, 0xd3, 0x8e,
                                   0x1f, 0xc3, 0xbb, 0xab, 0x78, 0xd5, 0x08, 0x1c};
...
TEST_F(AES256Test, DecryptGcmNon12ByteIv) {
    ...
    const byte_t iv_bytes[] = {0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27,
                               0x28, 0x29, 0x2a, 0x2b, 0x2c, 0x2d, 0x2e, 0x2f};
    const byte_t ciphertext[] = {0x28, 0x5c, 0x02, 0xb9, 0x3d};
    const byte_t tag[] = {0x75, 0x83, 0xb9, 0x3c, 0x6e, 0x5d, 0xd3, 0x8e,
                          0x1f, 0xc3, 0xbb, 0xab, 0x78, 0xd5, 0x08, 0x1c};
    const byte_t expected_plaintext[] = {0x48, 0x65, 0x6c, 0x6c, 0x6f};
...
TEST_F(AES256Test, EncryptGcmAllZeroKeyAndIv) {
    ...
    const byte_t plaintext[16] = {0};
    const byte_t expected_ciphertext[] = {0xce, 0xa6, 0xa4, 0x73, 0x95, 0x64, 0x16, 0x97,
                                          0x2a, 0xdd, 0xc2, 0x37, 0x9b, 0x6c, 0xdb, 0x76};
    const byte_t expected_tag[] = {0x72, 0x77, 0xda, 0x3a, 0xa5, 0x88, 0x8d, 0xc3,
                                   0x63, 0xda, 0xe8, 0xb9, 0xbb, 0x6d, 0x8a, 0x3c};
...
TEST_F(AES256Test, EncryptEcbHexNonHexCharacters) {
    ...
    auto result = AES256::encrypt_ecb_hex("test", invalid_key);
    auto decrypted = AES256::decrypt_ecb_hex(result.view(), invalid_key);
...
TEST_F(AES256Test, EncryptGcmKnownVectorWithLongAad) {
    ...
    const byte_t expected_ciphertext[] = {0x3b, 0x16, 0x93, 0x7e, 0xeb};
    const byte_t expected_tag[] = {0x97, 0x4c, 0xc1, 0xc3, 0x76, 0xbf, 0x0c, 0xa6,
                                   0x9a, 0x29, 0x0a, 0x6b, 0x09, 0x8a, 0x6a, 0x60};
...
TEST_F(AES256Test, EncryptGcmExactBlockBoundary) {
    ...
    const byte_t expected_ciphertext[] = {0xad, 0xd4, 0x87, 0x1c, 0x31, 0xa3, 0x56, 0x1b,
                                          0x74, 0x28, 0xc7, 0x31, 0xdd, 0x33, 0xab, 0xaf};
    const byte_t expected_tag[] = {0x25, 0xa7, 0x0b, 0x28, 0xb6, 0x97, 0x1c, 0xce,
                                   0x08, 0xd8, 0x20, 0xa9, 0xef, 0x2d, 0x7c, 0x93};
...
TEST_F(AES256Test, DecryptGcmExactBlockBoundary) {
    const byte_t key_bytes[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a,
                                ...
                                0x16, 0x17, 0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f};
    const byte_t iv_bytes[] = {0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b};
    const byte_t ciphertext[] = {0xad, 0xd4, 0x87, 0x1c, 0x31, 0xa3, 0x56, 0x1b,
                                 0x74, 0x28, 0xc7, 0x31, 0xdd, 0x33, 0xab, 0xaf};
    const byte_t tag[] = {0x25, 0xa7, 0x0b, 0x28, 0xb6, 0x97, 0x1c, 0xce,
                          0x08, 0xd8, 0x20, 0xa9, 0xef, 0x2d, 0x7c, 0x93};
