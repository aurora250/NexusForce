...
public:
     ...
     * @return 文件对象引用
     */
    MSTL_NODISCARD _MSTL file& file() noexcept {
        return file_;
    }
     ...
     * @return 文件对象常量引用
     */
    MSTL_NODISCARD const _MSTL file& file() const noexcept {
        return file_;
    }
     ...
     * @return 删除策略
     */
    MSTL_NODISCARD DELETE_POLICY delete_policy() const noexcept {
     ...
     */
    MSTL_NODISCARD static temp_file create_temp_file(
