...
public:
     ...
     * @return 目录路径
     */
    MSTL_NODISCARD const path& watch_path() const noexcept {
        return watch_path_;
    }
     ...
     * @return 事件类型
     */
    MSTL_NODISCARD FILE_WATCH_EVENT current_events() const noexcept {
     ...
     * @return 是否正在监视
     */
    MSTL_NODISCARD bool is_watching() const noexcept {
     ...
     * @return 是否递归
     */
    MSTL_NODISCARD bool is_recursive() const noexcept {
        return recursive_;
    }
