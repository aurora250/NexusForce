#ifndef MSTL_CORE_FILE_YAML_YAML_VALUE_HPP__
#define MSTL_CORE_FILE_YAML_YAML_VALUE_HPP__
...
class MSTL_API yaml_value : public istringify<yaml_value> {
public:
    string anchor;
    string tag;
    ...
    MSTL_NODISCARD virtual const yaml_null* as_null() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_boolean* as_boolean() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_integer* as_integer() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_float* as_float() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_string* as_string() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_timestamp* as_timestamp() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_sequence* as_sequence() const noexcept { return nullptr; }
    MSTL_NODISCARD virtual const yaml_mapping* as_mapping() const noexcept { return nullptr; }
    ...
    MSTL_NODISCARD bool is_timestamp() const noexcept { return type() == Timestamp; }
...
class MSTL_API yaml_null final : public yaml_value {
public:
    yaml_null() = default;
    MSTL_NODISCARD types type() const noexcept override { return Null; }
    MSTL_NODISCARD const yaml_null* as_null() const noexcept override { return this; }
};

class MSTL_API yaml_boolean final : public yaml_value {
private:
    bool value;
...
public:
    ...
    MSTL_NODISCARD const yaml_boolean* as_boolean() const noexcept override { return this; }
    MSTL_NODISCARD bool get_value() const noexcept { return value; }
};

class MSTL_API yaml_integer final : public yaml_value {
private:
    int64_t value;
...
public:
    ...
    MSTL_NODISCARD const yaml_integer* as_integer() const noexcept override { return this; }
    MSTL_NODISCARD int64_t get_value() const noexcept { return value; }
};

class MSTL_API yaml_float final : public yaml_value {
private:
    double value;
...
public:
    ...
    MSTL_NODISCARD const yaml_float* as_float() const noexcept override { return this; }
    MSTL_NODISCARD double get_value() const noexcept { return value; }
};

class MSTL_API yaml_string final : public yaml_value {
public:
    enum string_style {
        Plain,
        SingleQuoted,
...
public:
    ...
    : value(_MSTL move(v)), style(s) {}

    MSTL_NODISCARD types type() const noexcept override { return String; }
    MSTL_NODISCARD const yaml_string* as_string() const noexcept override { return this; }
    MSTL_NODISCARD const string& get_value() const noexcept { return value; }
    MSTL_NODISCARD string_style get_style() const noexcept { return style; }
};

class MSTL_API yaml_timestamp final : public yaml_value {
private:
    datetime value;
...
public:
    ...
    MSTL_NODISCARD types type() const noexcept override { return Timestamp; }
    MSTL_NODISCARD const yaml_timestamp* as_timestamp() const noexcept override { return this; }
...
class MSTL_API yaml_sequence final : public yaml_value {
public:
    enum sequence_style {
        Block,
        Flow
...
public:
    ...
    MSTL_NODISCARD const yaml_value* get_element(const size_t index) const noexcept {
        if (index < elements.size()) return elements[index].get();
        return nullptr;
    }

    MSTL_NODISCARD yaml_value* get_element(const size_t index) noexcept {
        if (index < elements.size()) return elements[index].get();
        return nullptr;
    }

    MSTL_NODISCARD size_t size() const noexcept { return elements.size(); }
    MSTL_NODISCARD const vector<yaml_ptr>& get_elements() const noexcept { return elements; }
    MSTL_NODISCARD sequence_style get_style() const noexcept { return style; }
    void set_style(const sequence_style s) noexcept { style = s; }
};

class MSTL_API yaml_mapping final : public yaml_value {
public:
    enum mapping_style {
        Block,
        Flow
...
public:
    ...
    MSTL_NODISCARD const yaml_value* get_member(const string& key) const {
        const auto it = members.find(key);
        if (it != members.end()) return it->second.get();
        return nullptr;
    }

    MSTL_NODISCARD yaml_value* get_member(const string& key) {
        const auto it = members.find(key);
        if (it != members.end()) return it->second.get();
        return nullptr;
    }
    ...
    MSTL_NODISCARD const unordered_map<string, yaml_ptr>& get_members() const noexcept {
        return members;
    }

    MSTL_NODISCARD mapping_style get_style() const noexcept { return style; }
...
MSTL_BEGIN_INNER__
string MSTL_API yaml_value_to_string(const yaml_value* value);
string MSTL_API yaml_value_document(const yaml_value* root);
MSTL_END_INNER__

MSTL_ALWAYS_INLINE_INLINE string to_string(const yaml_value* value) {
    return _INNER yaml_value_to_string(value);
}
MSTL_ALWAYS_INLINE_INLINE string to_string(const yaml_value& value) {
    return _INNER yaml_value_to_string(&value);
}
MSTL_ALWAYS_INLINE_INLINE string to_string(const yaml_ptr& value) {
    return _INNER yaml_value_to_string(value.get());
}

MSTL_NODISCARD MSTL_ALWAYS_INLINE_INLINE string yaml_value::to_string() const {
    return _INNER yaml_value_to_string(this);
}

MSTL_ALWAYS_INLINE_INLINE string yaml_document(const yaml_value* value) {
    return _INNER yaml_value_document(value);
}
MSTL_ALWAYS_INLINE_INLINE string yaml_document(const yaml_value& value) {
    return _INNER yaml_value_document(&value);
}
MSTL_ALWAYS_INLINE_INLINE string yaml_document(const yaml_ptr& value) {
    return _INNER yaml_value_document(value.get());
}

MSTL_NODISCARD MSTL_ALWAYS_INLINE_INLINE string yaml_value::to_document() const {
    return _INNER yaml_value_document(this);
}

MSTL_END_NAMESPACE__
#endif // MSTL_CORE_FILE_YAML_YAML_VALUE_HPP__
