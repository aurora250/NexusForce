#ifndef MSTL_CORE_CONTAINER_SET_HPP__
#define MSTL_CORE_CONTAINER_SET_HPP__
...
public:
	...
	pair<iterator, bool> insert(value_type&& value) {
		return tree_.insert_unique(_MSTL move(value));
	}
...
#endif // MSTL_CORE_CONTAINER_SET_HPP__
