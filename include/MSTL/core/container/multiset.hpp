#ifndef MSTL_CORE_CONTAINER_MULTISET_HPP__
#define MSTL_CORE_CONTAINER_MULTISET_HPP__
...
public:
     ...
     */
    MSTL_NODISCARD iterator find(const key_type& key) { return tree_.find(key); }
     ...
     */
    MSTL_NODISCARD const_iterator find(const key_type& key) const { return tree_.find(key); }
     ...
     * @return 匹配的元素数量
     */
    MSTL_NODISCARD size_type count(const key_type& key) const { return tree_.count(key); }
     ...
     */
    MSTL_NODISCARD iterator lower_bound(const key_type& key) { return tree_.lower_bound(key); }
     ...
     */
    MSTL_NODISCARD const_iterator lower_bound(const key_type& key) const { return tree_.lower_bound(key); }
     ...
     */
    MSTL_NODISCARD iterator upper_bound(const key_type& key) { return tree_.upper_bound(key); }
     ...
     */
    MSTL_NODISCARD const_iterator upper_bound(const key_type& key) const { return tree_.upper_bound(key); }
...
#endif // MSTL_CORE_CONTAINER_MULTISET_HPP__
