...
public:
     ...
     * @return 当前节点指针
     */
    MSTL_NODISCARD node_type* base() const noexcept {
        return current_;
    }
...
public:
    ...
    list(size_type n, T&& value) {
        ...
        try {
            while (n--) {
                pos = list::emplace(pos, _MSTL forward<T>(value));
            }
        } catch (...) {
            clear();
            throw;
    ...
    iterator emplace(iterator position, Args&&... args) {
        link_type temp = list::create_node(_MSTL forward<Args>(args)...);
    ...
    iterator emplace_back(Args&&... args) {
        return list::emplace(end(), _MSTL forward<Args>(args)...);
    }
    ...
    iterator emplace_front(Args&&... args) {
        return list::emplace(begin(), _MSTL forward<Args>(args)...);
    }
    ...
    void push_front(T&& value) {
        list::insert(begin(), _MSTL forward<T>(value));
    }
    ...
    void push_back(T&& value) {
        list::insert(end(), _MSTL forward<T>(value));
    }
    ...
    iterator insert(iterator position, T&& value) {
        return list::emplace(position, _MSTL move(value));
    }
    ...
    void merge(list& other) {
        list::merge_if(other, _MSTL less<T>());
    }
    ...
    void unique() noexcept {
        list::unique_if(_MSTL equal_to<T>());
    }
