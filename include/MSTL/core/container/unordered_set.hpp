#ifndef MSTL_CORE_CONTAINER_UNORDERED_SET_HPP__
#define MSTL_CORE_CONTAINER_UNORDERED_SET_HPP__
...
public:
     ...
     * @return 哈希函数对象的副本
     */
    MSTL_NODISCARD hasher hash_funct() const
     ...
     * @return 键相等比较函数对象的副本
     */
    MSTL_NODISCARD key_equal key_eq() const
...
#endif // MSTL_CORE_CONTAINER_UNORDERED_SET_HPP__
