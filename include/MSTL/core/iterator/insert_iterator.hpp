...
public:
    ...
    MSTL_CONSTEXPR20 ~back_insert_iterator() noexcept = default;  ///< 析构函数

    MSTL_NODISCARD constexpr back_insert_iterator& operator *() noexcept { return *this; }  ///< 解引用操作符
 ...
 */
template <typename Container>
MSTL_NODISCARD constexpr back_insert_iterator<Container>
make_back_inserter(Container& x) noexcept {
...
public:
    ...
    MSTL_CONSTEXPR20 ~front_insert_iterator() noexcept = default;  ///< 析构函数

    MSTL_NODISCARD constexpr front_insert_iterator& operator *() noexcept { return *this; }  ///< 解引用操作符
 ...
 */
template <typename Container>
MSTL_NODISCARD constexpr front_insert_iterator<Container>
make_front_inserter(Container& x) noexcept {
...
public:
    ...
    MSTL_CONSTEXPR20 ~insert_iterator() noexcept = default;  ///< 析构函数

    MSTL_NODISCARD constexpr insert_iterator& operator *() noexcept { return *this; }  ///< 解引用操作符
