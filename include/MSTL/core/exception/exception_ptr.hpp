#ifndef MSTL_CORE_EXCEPTION_EXCEPTION_PTR_HPP__
#define MSTL_CORE_EXCEPTION_EXCEPTION_PTR_HPP__
...
exception_ptr make_exception_ptr(Ex ex) noexcept {
    try {
        ...
        unique_ptr<exception_ptr::ecb> control_block(new exception_ptr::ecb(_MSTL move(wrapper)));
