...
constexpr time_point<Clock, ToDur> time_cast(const time_point<Clock, Dur>& time_point_value) {
    return time_point<Clock, ToDur>(_MSTL time_cast<ToDur>(time_point_value.since_epoch()));
}
...
public:
    ...
    MSTL_ALWAYS_INLINE time_point<Clock, nanoseconds> to_nano() const {
        return _MSTL time_cast<nanoseconds>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, microseconds> to_micro() const {
        return _MSTL time_cast<microseconds>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, milliseconds> to_milli() const {
        return _MSTL time_cast<milliseconds>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, seconds> to_sec() const {
        return _MSTL time_cast<seconds>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, minutes> to_minu() const {
        return _MSTL time_cast<minutes>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, hours> to_hour() const {
        return _MSTL time_cast<hours>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, days> to_day() const {
        return _MSTL time_cast<days>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, weeks> to_week() const {
        return _MSTL time_cast<weeks>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, years> to_year() const {
        return _MSTL time_cast<years>(*this);
    }
    MSTL_ALWAYS_INLINE time_point<Clock, months> to_month() const {
...
: duration(_MSTL time_cast<Dur>(tp.since_epoch())) {}
