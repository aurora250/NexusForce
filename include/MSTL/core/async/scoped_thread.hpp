...
#include "MSTL/core/async/stop_token.hpp"
...
private:
    ...
    static thread create(stop_source& source, Callable func, Object&& object, Args&&... args) {
        return thread{func, _MSTL forward<Object>(object), source.get_token(), _MSTL forward<Args>(args)...};
    }
    ...
    static thread create(stop_source& source, Callable func, Args&&... args) {
        return thread{_MSTL forward<Callable>(func), source.get_token(), _MSTL forward<Args>(args)...};
    }
    ...
    static thread create(stop_source&, Callable func, Args&&... args) {
        ...
        return thread{_MSTL forward<Callable>(func), _MSTL forward<Args>(args)...};
    }
