...
#include "MSTL/core/async/promise.hpp"
...
public:
    ...
    : state_ptr(_INNER create_task_state<Res(Args...)>(_MSTL forward<Func>(function)))
    {}
...
protected:
    ...
    void join() {
        _MSTL call_once(once_flag, &_MSTL thread::join, &thread);
    }
};
