#ifndef MSTL_CORE_ASYNC_HAZARD_PTR_HPP__
#define MSTL_CORE_ASYNC_HAZARD_PTR_HPP__
...
private:
    ...
    void scan_and_reclaim() {
        ...
        _MSTL sort(hazards.begin(), hazards.end());
        ...
        while (current) {
            ...
            if (_MSTL binary_search(hazards.begin(), hazards.end(), current)) {
        ...
        tl_retire_list_ = _MSTL move(new_list);
    }
...
public:
    ...
    void retire(T* ptr, Deleter deleter = Deleter()) {
        ...
        auto* obj = new hazard_pointer_obj<T, Deleter>(ptr, _MSTL move(deleter));
...
public:
    ...
    void swap(hazard_pointer& other) noexcept {
        _MSTL swap(record_, other.record_);
        _MSTL swap(domain_, other.domain_);
    }
...
#endif // MSTL_CORE_ASYNC_HAZARD_PTR_HPP__
