#ifndef MSTL_CORE_SYSTEM_DEVICE_DEVICE_CONSTANTS_HPP__
#define MSTL_CORE_SYSTEM_DEVICE_DEVICE_CONSTANTS_HPP__
...
string MSTL_API to_string(DEVICE_TYPE type);

DEVICE_TYPE MSTL_API to_device_t(const string& str);
...
#endif // MSTL_CORE_SYSTEM_DEVICE_DEVICE_CONSTANTS_HPP__
