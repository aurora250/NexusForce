...
/** @brief 记录TRACE级别日志 */
#define NEFORCE_LOG_TRACE(msg) _NEFORCE logger::instance().trace(msg, __FILE__, __func__, __LINE__)
...
/** @brief 记录FATAL级别日志 */
#define NEFORCE_LOG_FATAL(msg) _NEFORCE logger::instance().fatal(msg, __FILE__, __func__, __LINE__)
