 ...
 */
template <typename T>
NEFORCE_ALWAYS_INLINE_INLINE remove_volatile_t<T>
 ...
 */
template <typename T>
NEFORCE_ALWAYS_INLINE_INLINE bool
atomic_cmpexch_weak(
...
struct atomic_flag {
	...
	NEFORCE_ALWAYS_INLINE void notify_one() noexcept {
		_NEFORCE atomic_notify_address(&flag_, false);
	}
	...
	NEFORCE_ALWAYS_INLINE void notify_all() noexcept {
		_NEFORCE atomic_notify_address(&flag_, true);
	}
...
public:
	...
	value_type operator ++() noexcept {
		return _NEFORCE atomic_add_fetch(&value_, 1, memory_order_seq_cst);
	}
	 ...
	 */
	value_type operator --() noexcept {
		return _NEFORCE atomic_sub_fetch(&value_, 1, memory_order_seq_cst);
	}
	...
	wait(value_type old, const memory_order mo = memory_order_seq_cst) const noexcept {
		_NEFORCE atomic_wait_address_v(&value_, old, [mo, this] {
			return this->load(mo);
		});
	}
	 ...
	 */
	NEFORCE_ALWAYS_INLINE void notify_one() noexcept {
		_NEFORCE atomic_notify_address(&value_, false);
	}
	 ...
	 */
	NEFORCE_ALWAYS_INLINE void notify_all() noexcept {
		_NEFORCE atomic_notify_address(&value_, true);
	}
...
public:
	...
	compare_exchange_weak(
		...
		const memory_order success, const memory_order failure) noexcept {
		NEFORCE_CONSTEXPR_ASSERT(is_valid_cmpexch_failure_order(failure));
		return _NEFORCE atomic_cmpexch_weak_any(
	...
	NEFORCE_ALWAYS_INLINE void
	wait(value_type old, const memory_order mo = memory_order_seq_cst) const noexcept {
		_NEFORCE atomic_wait_address_v(&ptr_, old, [mo, this] {
			return this->load(mo);
		});
	}
	 ...
	 */
	NEFORCE_ALWAYS_INLINE void notify_one() noexcept {
		_NEFORCE atomic_notify_address(&ptr_, false);
	}
	 ...
	 */
	NEFORCE_ALWAYS_INLINE void notify_all() noexcept {
		_NEFORCE atomic_notify_address(&ptr_, true);
	}
...
public:
	...
	wait(Float old, const memory_order mo = memory_order_seq_cst) const noexcept {
		_NEFORCE atomic_wait_address_v(&float_, old, [mo, this] {
			return this->load(mo);
		});
	}
	 ...
	 */
	NEFORCE_ALWAYS_INLINE void notify_one() noexcept {
		_NEFORCE atomic_notify_address(&float_, false);
	}
	 ...
	 */
	NEFORCE_ALWAYS_INLINE void notify_all() noexcept {
		_NEFORCE atomic_notify_address(&float_, true);
	}
...
public:
	 ...
	 * @param value 被引用的对象
	 */
	explicit atomic_ref_base(T& value) : ptr_(_NEFORCE addressof(value)) {
	...
	wait(T old, const memory_order mo = memory_order_seq_cst) const noexcept {
		_NEFORCE atomic_wait_address_v(ptr_, old, [this, mo] {
			return this->load(mo);
		});
	}
...
public:
	 ...
	 */
	T load(const memory_order mo = memory_order_seq_cst) const noexcept {
		return _NEFORCE atomic_load(ptr_, mo);
	}
	 ...
	 */
	value_type operator ++() noexcept {
		return _NEFORCE atomic_add_fetch(ptr_, value_type(1));
	}
	 ...
	 */
	value_type operator --() noexcept {
		return _NEFORCE atomic_sub_fetch(ptr_, value_type(1));
	}
	 ...
	 */
	value_type operator +=(value_type value) noexcept {
		return _NEFORCE atomic_add_fetch(ptr_, value);
	}
	 ...
	 */
	value_type operator -=(value_type value) noexcept {
		return _NEFORCE atomic_sub_fetch(ptr_, value);
	}
	 ...
	 */
	value_type operator &=(value_type value) noexcept {
		return _NEFORCE atomic_and_fetch(ptr_, value);
	}
	 ...
	 */
	value_type operator |=(value_type value) noexcept {
		return _NEFORCE atomic_or_fetch(ptr_, value);
	}
	 ...
	 */
	value_type operator ^=(value_type value) noexcept {
		return _NEFORCE atomic_xor_fetch(ptr_, value);
	}
};
