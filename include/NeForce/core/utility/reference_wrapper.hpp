#ifndef NEFORCE_CORE_UTILITY_REFERENCE_WRAPPER_HPP__
#define NEFORCE_CORE_UTILITY_REFERENCE_WRAPPER_HPP__
 ...
 */
template <typename T>
NEFORCE_NODISCARD constexpr reference_wrapper<const T> cref(reference_wrapper<T> wrapper) noexcept {
    return wrapper;
}
...
#endif // NEFORCE_CORE_UTILITY_REFERENCE_WRAPPER_HPP__
