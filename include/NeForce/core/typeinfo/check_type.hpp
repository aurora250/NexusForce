...
public:
    ...
    NEFORCE_CONSTEXPR20 output& operator ()() noexcept {
        return *this;
    }
...
struct bracket<false> {
    NEFORCE_CONSTEXPR20 bracket(output& out, const char* str = nullptr) {
        out(str);
    }
};
...
struct at_destruct {
    ...
    NEFORCE_CONSTEXPR20 void set_str(const char* str = nullptr) noexcept {
        str_ = str;
    }
};
