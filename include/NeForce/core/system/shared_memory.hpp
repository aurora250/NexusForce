...
/**
 * @struct shared_memory_exception
 * @extends system_exception
 * @brief 共享内存操作异常
 */
struct shared_memory_exception final : system_exception {
    explicit shared_memory_exception(
    ...
    explicit shared_memory_exception(const exception& e)
    : system_exception(e) {}

    ~shared_memory_exception() override = default;
 ...
 */
class NEFORCE_API shared_memory {
public:
    /**
     * @enum access_mode
     * @brief 访问模式枚举
...
public:
     ...
     * @param mode 打开模式
     * @param access 访问模式
     * @throws shared_memory_exception 创建或打开失败时抛出
     */
     ...
     * @param mode 打开模式
     * @param access 访问模式
     * @throws shared_memory_exception 操作失败时抛出
     */
    void open(
        const string& name,
        size_t size,
     ...
     * @return 映射地址
     * @throws shared_memory_exception 映射失败时抛出
     */
