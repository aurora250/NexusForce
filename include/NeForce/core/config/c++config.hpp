 ...
 */
	...
	#if (__WORDSIZE == 32) || (__SIZEOF_POINTER__ == 4) || defined(NEFORCE_PLATFORM_LINUX64) || defined(NEXUSFORCE_ENABLE_DOXYGEN)
        /**
...
#endif
#if (__cplusplus >= 202002L) || defined(NEFORCE_STANDARD_23) || (_MSVC_LANG >= 202002L) || defined(NEXUSFORCE_ENABLE_DOXYGEN)
    /**
...
#endif
#if (__cplusplus >= 201703L) || defined(NEFORCE_STANDARD_20) || (_MSVC_LANG >= 201703L) || defined(NEXUSFORCE_ENABLE_DOXYGEN)
    /**
...
#endif
#if (__cplusplus >= 201402L) || defined(NEFORCE_STANDARD_17) || (_MSVC_LANG >= 201402L) || defined(NEXUSFORCE_ENABLE_DOXYGEN)
    /**
...
#endif
#if (__cplusplus >= 201103L) || defined(NEFORCE_STANDARD_14) || (_MSVC_LANG >= 201103L) || defined(NEXUSFORCE_ENABLE_DOXYGEN)
    /**
...
#endif
#if (__cplusplus >= 199711L) || defined(NEFORCE_STANDARD_11) || (_MSVC_LANG >= 199711L) || defined(NEXUSFORCE_ENABLE_DOXYGEN)
    /**
