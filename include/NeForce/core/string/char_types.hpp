 ...
 * 包含水平制表符(9)和空格(32)。
 */
NEFORCE_INLINE17 constexpr uint64_t BLANK_MASK = (1ULL << 9) | // \t
                                                 (1ULL << 32); // space
 ...
 */
NEFORCE_INLINE17 constexpr uint64_t SPACE_MASK = BLANK_MASK | (1ULL << 10) | // \n
                                                 (1ULL << 11) |              // \v
                                                 (1ULL << 12) |              // \f
                                                 (1ULL << 13);               // \r
...
NEFORCE_INLINE17 constexpr uint64_t PUNCT_MASK_HIGH =
        ...
        (1ULL << (92 - 64)) | (1ULL << (93 - 64)) | (1ULL << (94 - 64)) |
        (1ULL << (95 - 64)) | // \\(92)、](93)、^(94)、_(95)
        (1ULL << (96 - 64)) | (1ULL << (123 - 64)) | (1ULL << (124 - 64)) |
        (1ULL << (125 - 64)) | // `(96)、{(123)、|(124)、}(125)
        (1ULL << (126 - 64));  // ~(126)
 ...
 * 包含ASCII码127。
 */
NEFORCE_INLINE17 constexpr uint64_t CNTRL_MASK_HIGH = (1ULL << (127 - 64)); // DEL(127)
