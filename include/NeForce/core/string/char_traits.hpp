#ifndef NEFORCE_CORE_STRING_CHAR_TRAITS_HPP__
#define NEFORCE_CORE_STRING_CHAR_TRAITS_HPP__
...
struct base_char_traits {
     ...
     * @return 字符串长度（不含空字符）
     */
    NEFORCE_NODISCARD static constexpr size_t length(const char_type* str) noexcept {
        return _NEFORCE string_length(str);
    }
     ...
     * @return 非EOF值或0
     */
    NEFORCE_NODISCARD static constexpr int_type not_eof(const int_type rsc) noexcept {
