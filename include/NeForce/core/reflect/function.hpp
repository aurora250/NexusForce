...
public:
    ...
    size_t max_args() const { return max_args_; }
...
Ret invoke_impl(Class* obj, Ret (Class::*func)(Args...), const vector<_REFLECT any>& args, index_sequence<Is...>) {
    return (obj->*func)(args[Is].template convert<Args>()...);
}

template <typename Ret, typename Class, typename... Args, size_t... Is>
Ret invoke_impl(const Class* obj, Ret (Class::*func)(Args...) const, const vector<_REFLECT any>& args, index_sequence<Is...>) {
    return (obj->*func)(args[Is].template convert<Args>()...);
}
...
decltype(auto) make_member_invoker(Ret (Class::*func)(Args...)) {
    return [func](void* obj, const vector<_REFLECT any>& args) -> _REFLECT any {
        ...
        if constexpr (is_void_v<Ret>) {
            _INNER invoke_impl(static_cast<Class*>(obj), func, args, make_index_sequence<sizeof...(Args)>{});
            return _REFLECT any{};
        } else {
            auto result = _INNER invoke_impl(static_cast<Class*>(obj), func, args, make_index_sequence<sizeof...(Args)>{});
            return _REFLECT any(result);
        }
    };
}
...
decltype(auto) make_const_member_invoker(Ret (Class::*func)(Args...) const) {
    return [func](void* obj, const vector<_REFLECT any>& args) -> _REFLECT any {
        ...
        if constexpr (is_void_v<Ret>) {
            _INNER invoke_impl(static_cast<const Class*>(obj), func, args, make_index_sequence<sizeof...(Args)>{});
            return _REFLECT any{};
        } else {
            auto result = _INNER invoke_impl(static_cast<const Class*>(obj), func, args, make_index_sequence<sizeof...(Args)>{});
            return _REFLECT any(result);
        }
    };
}
...
decltype(auto) make_static_invoker(Ret (*func)(Args...)) {
    return [func](void*, const vector<_REFLECT any>& args) -> _REFLECT any {
        ...
        if constexpr (is_void_v<Ret>) {
            _INNER invoke_impl(nullptr, func, args, make_index_sequence<sizeof...(Args)>{});
            return _REFLECT any{};
        } else {
            auto result = _INNER invoke_impl(nullptr, func, args, make_index_sequence<sizeof...(Args)>{});
            return _REFLECT any(result);
        }
    };
}
