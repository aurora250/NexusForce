...
private:
	 ...
	 */
	template <typename Iterator>
	NEFORCE_CONSTEXPR20 enable_if_t<!is_ranges_fwd_iter_v<Iterator>>
...
public:
	 ...
	 * @param value 初始值
	 */
	NEFORCE_CONSTEXPR20 explicit vector(const size_type n, const T& value) {
	 ...
	 * @param value 初始值
	 */
	NEFORCE_CONSTEXPR20 explicit vector(const int32_t n, const T& value) {
		vector::fill_initialize(n, value);
	}
	 ...
	 * @param value 初始值
	 */
	NEFORCE_CONSTEXPR20 explicit vector(const int64_t n, const T& value) {
		vector::fill_initialize(n, value);
	}
	 ...
	 * @param other 源向量
	 */
	NEFORCE_CONSTEXPR20 vector(vector&& other)
	 ...
	 * @return 自身引用
	 */
	NEFORCE_CONSTEXPR20 vector& operator =(vector&& other)
	noexcept(
	...
	NEFORCE_CONSTEXPR20 void push_back(T&& value) {
		vector::emplace_back(_NEFORCE move(value));
	}
	 ...
	 * @return 被移除的元素
	 */
	NEFORCE_CONSTEXPR20 T pop_back_v()
	 ...
	 */
	NEFORCE_CONSTEXPR20 iterator erase(iterator first, iterator last)
	 ...
	 */
	NEFORCE_CONSTEXPR20 iterator erase(iterator position)
	 ...
	 */
	NEFORCE_CONSTEXPR20 void swap(vector& other)
