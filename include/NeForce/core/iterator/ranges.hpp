...
concept common_range = Range<R> && same_as<
    decltype(_NEFORCE declval<R>().begin()),
    decltype(_NEFORCE declval<R>().end())
>;
...
public:
    ...
    : base_(_NEFORCE move(base)), pred_(_NEFORCE move(pred)) {}
...
public:
    ...
    : base_(_NEFORCE move(base)), func_(_NEFORCE move(func)) {}
...
public:
    ...
    constexpr pointer operator->() const {
        return _NEFORCE addressof(*current_);
    }
...
public:
    ...
    : base_(_NEFORCE move(base)), count_(count) {}
...
public:
    ...
    constexpr explicit reverse_view(V base) : base_(_NEFORCE move(base)) {}
...
public:
    ...
    constexpr explicit iota_view(T start) : start_(start) {}
...
public:
    ...
    : value_(_NEFORCE move(value)), count_(count), has_bound_(true) {}
...
public:
    ...
    constexpr explicit join_view(V base) : base_(_NEFORCE move(base)) {}
...
public:
    ...
    constexpr reference operator*() const {
        return _NEFORCE get<N>(*current_);
    }

    constexpr pointer operator->() const {
        return _NEFORCE addressof(_NEFORCE get<N>(*current_));
    }
...
public:
    ...
    constexpr explicit element_view(V base) : base_(_NEFORCE move(base)) {}
...
public:
    ...
    constexpr explicit common_view(V base) : base_(_NEFORCE move(base)) {}
...
public:
    ...
    : base_(_NEFORCE move(base)), delimiter_(delimiter) {}
...
public:
    ...
    : base_(_NEFORCE move(base)), offset_(offset), length_(length) {}
...
struct filter_adaptor_closure : range_adaptor_closure<filter_adaptor_closure<Pred>> {
    ...
    constexpr explicit filter_adaptor_closure(Pred p) : pred(_NEFORCE move(p)) {}
...
struct transform_adaptor_closure : range_adaptor_closure<transform_adaptor_closure<Func>> {
    ...
    constexpr explicit transform_adaptor_closure(Func f) : func(_NEFORCE move(f)) {}
...
struct take_while_adaptor_closure : range_adaptor_closure<take_while_adaptor_closure<Pred>> {
    ...
    constexpr explicit take_while_adaptor_closure(Pred p) : pred(_NEFORCE move(p)) {}
...
struct drop_while_adaptor_closure : range_adaptor_closure<drop_while_adaptor_closure<Pred>> {
    ...
    constexpr explicit drop_while_adaptor_closure(Pred p) : pred(_NEFORCE move(p)) {}
...
struct elements_adaptor_closure : range_adaptor_closure<elements_adaptor_closure<N>> {
    template <Range R>
    constexpr auto operator ()(R&& range) const {
        return element_view<N, decltype(all(_NEFORCE forward<R>(range)))>{
            all(_NEFORCE forward<R>(range))
        };
    }
};
