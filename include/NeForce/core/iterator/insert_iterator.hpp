 ...
 */
template <typename Container>
NEFORCE_NODISCARD constexpr back_insert_iterator<Container>
 ...
 */
template <typename Container>
NEFORCE_NODISCARD constexpr front_insert_iterator<Container>
...
public:
    ...
    : container(_NEFORCE addressof(x)), iter(_NEFORCE move(it)) {}
 ...
 */
template <typename Container>
NEFORCE_NODISCARD constexpr insert_iterator<Container>
