...
private:
	...
	template <typename R1, typename R2,
		 intmax_t Gcd1 = _NEFORCE gcd(R1::num, R2::num),
...
public:
	...
	NEFORCE_ALWAYS_INLINE duration<Rep, nano> to_nano() const {
		return _NEFORCE time_cast<nanoseconds>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, micro> to_micro() const {
		return _NEFORCE time_cast<microseconds>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, milli> to_milli() const {
		return _NEFORCE time_cast<milliseconds>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep> to_sec() const {
		return _NEFORCE time_cast<seconds>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, ratio<60>> to_minu() const {
		return _NEFORCE time_cast<minutes>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, ratio<3600>> to_hour() const {
		return _NEFORCE time_cast<hours>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, ratio<86400>> to_day() const {
		return _NEFORCE time_cast<days>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, ratio<604800>> to_week() const {
		return _NEFORCE time_cast<weeks>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, ratio<31556952>> to_year() const {
		return _NEFORCE time_cast<years>(*this);
	}
	NEFORCE_ALWAYS_INLINE duration<Rep, ratio<2629746>> to_month() const {
...
NEFORCE_NODISCARD constexpr enable_if_t<is_duration_v<ToDur>, ToDur>
