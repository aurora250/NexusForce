...
public:
    NEFORCE_NODISCARD static constexpr decimal_t min_posi() noexcept { return 3.36210314311209350626267781732175260e-4932L; }
    NEFORCE_NODISCARD static constexpr decimal_t max_posi() noexcept { return 1.18973149535723176502126385303097021e+4932L; }
    NEFORCE_NODISCARD static constexpr decimal_t min_nega() noexcept { return -1.18973149535723176502126385303097021e+4932L; }
    NEFORCE_NODISCARD static constexpr decimal_t max_nega() noexcept { return -3.36210314311209350626267781732175260e-4932L; }
