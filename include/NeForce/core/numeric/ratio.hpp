#ifndef NEFORCE_CORE_NUMERIC_RATIO_HPP__
...
struct ratio {
    ...
    static constexpr intmax_t num =
            Numerator * static_sign<Denominator>::value / static_gcd<Numerator, Denominator>::value; ///< 约分后的分子
    static constexpr intmax_t den =
            static_abs<Denominator>::value / static_gcd<Numerator, Denominator>::value; ///< 约分后的分母
