...
template <typename T, typename CharT> struct icharacter : ipackage<T, CharT> {
     ...
     * @return 普通字符串
     */
    static NEFORCE_CONSTEXPR20 string to_string(const basic_string_view<CharT>& obj) { return T::to_string(obj); }
     ...
     * @return 宽字符串
     */
    static NEFORCE_CONSTEXPR20 wstring to_wstring(const basic_string_view<CharT>& obj) { return T::to_wstring(obj); }
     ...
     * @return UTF-8字符串
     */
    static NEFORCE_CONSTEXPR20 u8string to_u8string(const basic_string_view<CharT>& obj) { return T::to_u8string(obj); }
#endif
