#ifndef NEFORCE_CORE_FILE_ENV_ENV_PARSER_HPP__
#define NEFORCE_CORE_FILE_ENV_ENV_PARSER_HPP__
...
private:
     ...
     * @return 是否为空白行
     */
    NEFORCE_NODISCARD bool is_blank_line(const string& line) const;
