...
public:
    ...
    void set_not_found_handler(handler_func handler) { not_found_handler_ = _NEFORCE move(handler); }
    void set_method_not_allowed_handler(handler_func handler) { method_not_allowed_handler_ = _NEFORCE move(handler); }
